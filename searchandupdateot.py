...
def searchAndUpdateUser(incidentId,ususarioAsignado):    
    ...
    while mod_consulta_popup is None:        
        mod_consulta_popup = pyautogui.locateOnScreen('C:/BOT BPO Automation/Version 1.0/assets/mod_consulta_popup-2.png', grayscale = True,confidence=0.85)            
...
def searchAndUpdateBillingItem(incidentId,BillingItem):    
    ...
    #/////////////////////////////////// CRM DASHBOARD ///////////////////////////////////////////    
    while crm_dashboard is None:
        crm_dashboard = pyautogui.locateOnScreen('C:/BOT BPO Automation/Version 1.0/assets/crm_dashboard-2.png', grayscale = True,confidence=0.85)
        sleep(0.5)
        if crmAttempts == 5:
    ...
    if(BillingItem == 'ADMON OTS CLIENTES ESTRATEGICOS-GRANDES'):
        pressingKey('down',6)
    elif(BillingItem == 'ADMON OTS CLIENTES INTERMEDIO-PYMES-REGIONALES'):
        pressingKey('down',7)
    elif(BillingItem == 'ADMON OTS SOLO CONFIG-CASOS DE SEGUIMIENTO'):
        pressingKey('down',8)    
    ...
    crmAttempts = 0
    while crm_warning_message is None and crmAttempts < 10:        
        crm_warning_message = pyautogui.locateOnScreen('C:/BOT BPO Automation/Version 1.0/assets/crm_process_message2.png', grayscale = True,confidence=0.9)   
        sleep(0.5)
        if crmAttempts == 8:
            print("Estoy dentro de los 8 intentos de medio seg para esperar algun pop up inesperado en el CRM")                        
        crmAttempts += 1
