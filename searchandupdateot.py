...
def searchAndUpdateBillingItem(incidentId,BillingItem):
    crm_dashboard = crm_assign_user = crm_edit_incident = crm_save_incident = crm_otp_saved_sucessfully = mod_consulta_popup = None 
    billingItem_field = None
    crmAttempts = 0   
    ...
    scrollTimes = 0
    pyautogui.moveTo(184, 594)
    while billingItem_field is None and scrollTimes <= 300:
        pyautogui.scroll(-15)
        sleep(0.05)
